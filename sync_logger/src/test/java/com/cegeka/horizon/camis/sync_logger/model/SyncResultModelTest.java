...
public class SyncResultModelTest {
    ...
    public void givenCorrectHoursMinimumSyncErrorRecord_whenAddSyncResult_thenAddedRecordToSyncResult() {
        HoursMinimumSyncError hoursMinimumSyncErrorRecord = new HoursMinimumSyncError(new EmployeeIdentification(new ResourceId("I000001"), "Employee1"), new RecordData(LocalDate.now(), "Message 1", new WorkOrder("001.001")), 40);
    ...
    public void givenCorrectHoursNotEqualSyncErrorRecord_whenAddSyncResult_thenAddedRecordToSyncResult() {
        HoursNotEqualSyncError hoursNotEqualSyncErrorRecord = new HoursNotEqualSyncError(new EmployeeIdentification(new ResourceId("I000002"), "Employee2"), new RecordData(LocalDate.now(), "Message 2", new WorkOrder("002.002")));
    ...
    public void givenCorrectNoActionSyncRecord_whenAddSyncResult_thenAddedRecordToSyncResult() {
        NoActionSyncCorrect noActionSyncCorrectRecord = new NoActionSyncCorrect(new EmployeeIdentification(new ResourceId("I000003"), "Employee3"), new RecordData(LocalDate.now(), "Message 3", new WorkOrder("003.003")));
    ...
    public void givenCorrectOtherSyncErrorRecord_whenAddSyncResult_thenAddedRecordToSyncResult() {
        OtherSyncError otherSyncError = new OtherSyncError(new EmployeeIdentification(new ResourceId("I000004"), "Employee4"), new RecordData(LocalDate.now(), "Message 4", new WorkOrder("004.004")));
    ...
    public void givenCorrectUpdateTimesheetLineSyncErrorAndCorrectRecord_whenAddSyncResult_thenAddedRecordToSyncResult() {
        UpdateTimesheetLineSyncErrorAndCorrect updateTimesheetLineSyncErrorAndCorrect = new UpdateTimesheetLineSyncErrorAndCorrect(new EmployeeIdentification(new ResourceId("I000005"), "Employee5"), new RecordData(LocalDate.now(), "Message 3", new WorkOrder("005.005")), 40);
