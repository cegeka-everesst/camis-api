...
import com.cegeka.horizon.camis.timesheet.builder.WeeklyTimesheetTestBuilder;
...
import static com.cegeka.horizon.camis.timesheet.builder.TestLocalDates.WEEK_1_MONDAY;
import static com.cegeka.horizon.camis.timesheet.builder.TestLocalDates.WEEK_1_THURSDAY;
import static com.cegeka.horizon.camis.timesheet.builder.TestLocalDates.WEEK_1_TUESDAY;
import static com.cegeka.horizon.camis.timesheet.builder.TestLocalDates.WEEK_1_WEDNESDAY;
import static com.cegeka.horizon.camis.timesheet.builder.TestLocalDates.WEEK_2_MONDAY;
import static com.cegeka.horizon.camis.timesheet.builder.TestLocalDates.WEEK_2_SUNDAY;
import static com.cegeka.horizon.camis.timesheet.builder.TestLocalDates.WEEK_2_TUESDAY;
...
class EmployeeTest {
    ...
    @Test
    void givenWeeklyTimesheets_whenSameWeek_thenMerge() {
