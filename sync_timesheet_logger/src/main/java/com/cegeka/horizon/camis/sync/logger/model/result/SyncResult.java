...
import static com.cegeka.horizon.camis.sync.logger.model.result.SyncResultType.INSUFFICIENT_HOURS_ERROR;
import static com.cegeka.horizon.camis.sync.logger.model.result.SyncResultType.NO_SYNC_REQUIRED;
import static com.cegeka.horizon.camis.sync.logger.model.result.SyncResultType.OTHER_SYNC_ERROR;
import static com.cegeka.horizon.camis.sync.logger.model.result.SyncResultType.SUCCESS;
import static com.cegeka.horizon.camis.sync.logger.model.result.SyncResultType.UNABLE_TO_UPDATE_TIMESHEET_ERROR;
import static com.cegeka.horizon.camis.sync.logger.model.result.SyncResultType.WARNING;
